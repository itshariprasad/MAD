...
//Toast.makeText(MainActivity.this,"3",Toast.LENGTH_LONG).show();
    ...
    {
        myHotels.add(new Hotel("Gulaab Jamoon",25,"veg",R.drawable.gulabjamoon ));
        myHotels.add(new Hotel("Chicken",10,"Non-Veg",R.drawable.butterchicken));
        myHotels.add(new Hotel("Kabab",15,"Non-veg",R.drawable.chickenkabab ));
        myHotels.add(new Hotel("Gobi", 12,"Veg", R.drawable.gobi));
    ...
    private void registerClickCallBack()
    {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View viewClicked,  final int position, long id) {
                ...
                viewClicked.setBackgroundColor(Color.rgb(0,0,153));
                ...
                String message = "You Clicked " + clickedHotel.getName() + "  Contains Chicken Cooked in Tomato Sauce \n Ingredients - Butter,Chicken,Tomato Sauce \n It is sweet";
                String test = clickedHotel.getName();
                String message1 = "You Clicked " + clickedHotel.getName() + "  is sweet dish cooked in sugar Syrup \n Ingredients - Gulab Jamoon Mix,Sugar,Water \n It is a sweet dish ";
                String message2 = "You Clicked " + clickedHotel.getName() + " is a Chicken Started made from Chicken \n Ingredients - Chicken Onions \n It is very Spicy";
                String message3 = "You Clicked " + clickedHotel.getName() + " is a Vegeterian Starter made from Cauliflower \n Ingredients - Cauliflower Flour Salt \n It is Medium Spicy";
                String message4 = "You Clicked " + clickedHotel.getName() + "  is a Vegeterian Main Course made with ghee and rice \n Ingredients - Rice Beans Ghee Salt Chillies \n It is a Sweet Dish";
                String message5 = "You Clicked " + clickedHotel.getName();

                if (test == "Butter Chicken") {
                    Toast.makeText(MainActivity.this, message, Toast.LENGTH_SHORT).show();
                }else if (test == "Gulab Jamoon") {
                    Toast.makeText(MainActivity.this, message1, Toast.LENGTH_SHORT).show();
                }else if(test == "Chicken Kabab"){
                    Toast.makeText(MainActivity.this, message2, Toast.LENGTH_SHORT).show();
                }else if(test == "Gobi Manchuri") {
                    Toast.makeText(MainActivity.this, message3, Toast.LENGTH_SHORT).show();
                }else if(test == "Ghee Rice"){
